    ...
    public void onBindViewHolder(RAdapterCategory.ViewH holder, int position) {
        ...
        holder.mButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                activity.getSupportFragmentManager().beginTransaction().setCustomAnimations(R.anim.enterfromright,R.anim.exittoleft,R.anim.enterfromleft,R.anim.exittoright).replace(R.id.content,TabbedItemGallery.newInstance(item)).addToBackStack(null).commit();
